...
outputfile = 'wdm5p3keV.txt'
chi1=5300.0
chi2=5300.0
rwarm=0.1
omegatot = 0.1198
TwdmOverTnu = pow(omegatot*94/chi2,1./3.);
#TwdmOverTnu = pow(rwarm*omegatot*94/chi2,1./3.);
TnuOverTgamma = pow(4./11.,1./3.)
TwdmOverTgamma = TwdmOverTnu*TnuOverTgamma;
kmax=2000.0
redshift=0.0
hinput=0.6727
mncdm= [chi1,chi2]
omegancdm = [(1-rwarm)*omegatot, rwarm*omegatot] 
#omegancdm = [0.00001,0.00001]
#Tncdm=[0.332,TwdmOverTgamma]
Tncdm = [TwdmOverTgamma,TwdmOverTgamma]
Nbins=[2000,2000]
Npsdncdm = [1,1]
WDMsetting = {'N_ncdm':2 , 
...
'ncdm_psd_filenames': 'psd_FD_single.dat,psd_FD_single.dat', 
'h':hinput,
'n_s':0.954 ,
'sigma8':0.796 ,
'z_reio':8.5}
